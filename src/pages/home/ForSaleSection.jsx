  ...
  return (
    <div className="xl:grid xl:grid-cols-12 xl:gap-4 xl:items-center">
      <div className="col-span-4 xl:pr-16 text-center xl:text-left">
        <h2 className="text-4xl font-bold text-gray-900 mb-4">For RoomMate</h2>
        <p className="text-gray-600 leading-loose xl:mb-12 mb-6">
          Finding the right roommate can significantly impact your living experience, both socially and financially.
        </p>
