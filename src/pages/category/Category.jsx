...
function Category() {
  ...
  const pageTitle = categoryName === 'sale' ? 'For RoomMate' : 'For Rent';
        ...
        <div className="sm:flex items-center justify-between mb-8">
          ...
          <div className="flex items-center justify-start gap-5 flex-1 max-w-sm sm:mx-0 mx-auto">
            ...
            <select
              ...
              <option value="bedrooms">Types</option>
              <option value="bathrooms">Area</option>
              {/* <option value="carspace">Car space</option> */}
              <option value="listingSize">Distance</option>
            </select>
          </div>
        </div>
